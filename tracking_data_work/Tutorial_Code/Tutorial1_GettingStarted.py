...
# Shot direction
ax.annotate("", xy=events.loc[198][['End X', 'End Y']], xytext=events.loc[198][['Start X', 'Start Y']], alpha=0.6,
            arrowprops=dict(arrowstyle="->", color='r'))

# plot passing move in run up to goal
mviz.plot_events(events.loc[190:197], indicators=['Marker', 'Arrow'], annotate=True, figax=(fig,ax))
...
fig, ax = mviz.plot_pitch()
# [x_pos,y_pos, colour, marker size]
